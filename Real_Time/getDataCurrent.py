    ...
    for filename in os.listdir(directory):
        ...
        for i in range(2, 90):
            ...
            try:
                ...
                if(d[n].get(s)):
                    sheet.cell(row=i, column=19).value = d[n].get(s)
                    
                    
                
                elif (d[n].get(d1)):
                    sheet.cell(row=i, column=19).value = d[n].get(d1)
                    
                if(sheet.cell(row=i, column=5).value == 0 and len(sheet.cell(row=i, column=19).value)>1):
...
def main():
    ...
    book3 = openpyxl.load_workbook('2018-2019_combined_red.xlsx')
    sheet3 = book3.get_sheet_by_name('Sheet1')   
    row_count3 = sheet3.max_row
    year = "2019"
    #loadSportsVu(book3, sheet3, row_count3, year)
    ...
    loadInjured(beginDate, endDate, year)
    file = "injured_data_2019.xlsx"
    dict2019 = {}
    dict2019 = loadDict(file)
    
    
    
    #print(dict2019["LeBron James"])
    ...
    #fillDataWithInjuries(directory, dict2014)
    
    
    directory = "bball_reference_2014-2015"
    #fillDataWithInjuries(directory, dict2015)
    
    directory = "bball_reference_2018-2019"
    fillDataWithInjuries(directory, dict2019)
